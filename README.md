...
- [Data analysis](./docs/module_1/data_analysis.md)
...
### 5. Azure Storage for non-relational data

- [Azure Storage Redundancy](./docs/module_5/azure_storage_redundancy.md)
- [Azure Blob Storage](./docs/module_5/azure_blob_storage.md)
- [Azure DataLake Storage Gen2](./docs/module_5/azure_datalake_storage.md)
- [Azure Files](./docs/module_5/azure_files.md)
- [Azure Tables](./docs/module_5/azure_tables.md)

### 6. Fundamentals of Azure Cosmos DB

- [Azure Cosmos DB](./docs/module_6/azure_comsos_db.md)
- [Azure Cosmos DB APIs](./docs/module_6/azure_comsos_db_apis.md)
...
### 9. Fundamentals of data visualization

- [Power BI tools and workflow](./docs/module_9/power_bi.md)
- [Core concepts of data modeling](./docs/module_9/data_modeling.md)
- [Considerations for data visualization](./docs/module_9/data_visualization.md)